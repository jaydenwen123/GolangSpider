...
` [nginx] name=nginx repo baseurl=http://nginx.org/packages/OS/OSRELEASE/ $basearch / gpgcheck=0 enabled=1 复制代码`
...
` systemctl start nginx.service 复制代码`
...
` error_page 500 502 503 504 /50x.html; 复制代码`
