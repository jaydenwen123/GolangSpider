...
Go是一门并发支持 、垃圾回收的编译型系统编程语言，旨在创 造一门具有在静态编译语言的 高性能 和动态语言的 高效开发 之间拥有 良好平衡点的一门编程语言
...
![](https://user-gold-cdn.xitu.io/2019/5/14/16ab238a7c0065dc?imageView2/0/w/1280/h/960/ignore-error/1)
...
Go 语言被设计成一门应用于搭载 Web 服务器，存储集群或类似用途的巨型中央服务器的系统编程语言。 对于高性能分布式系统领域而言，Go语言无疑比大多数其它语言有着更高的开发效率。它提供了海量并行的支持，这对于游戏服务端的开发而言是再好不过了。
...
* [Docker]( https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Fdocker%2Fdocker-ce ) ：一组用于部署Linux容器的工具
* [Openshift]( https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Fopenshift%2Forigin ) ：由Red Hat提供的云计算平台即服务。
* [Kubernetes]( https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Fkubernetes%2Fkubernetes%2F ) ：无缝自动化部署流程的未来
* [Tidb]( https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Fpingcap%2Ftidb ) ： 开源分布式关系型数据库。
* [InfluxDB]( https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Finfluxdata%2Finfluxdb ) ：是由InfluxData开发的开源时间序列数据库。
* [Etcd]( https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Fetcd-io%2Fetcd ) ：分布式的键值对数据存储系统，提供共享配置、服务的注册和发现。
...
* **蚂蚁金服**
* **京东** （消息推送系统、云存储）
* **小米** （ [open-falcon.com/）小米互娱、小米商城、…]( https://link.juejin.im?target=http%3A%2F%2Fopen-falcon.com%2F%25EF%25BC%2589%25E5%25B0%258F%25E7%25B1%25B3%25E4%25BA%2592%25E5%25A8%25B1%25E3%2580%2581%25E5%25B0%258F%25E7%25B1%25B3%25E5%2595%2586%25E5%259F%258E%25E3%2580%2581%25E5%25B0%258F%25E7%25B1%25B3%25E8%25A7%2586%25E9%25A2%2591%25E3%2580%2581%25E5%25B0%258F%25E7%25B1%25B3%25E7%2594%259F%25E6%2580%2581%25E9%2593%25BE%25E7%25AD%2589%25E5%259B%25A2%25E9%2598%259F%25E9%2583%25BD%25E5%259C%25A8%25E4%25BD%25BF%25E7%2594%25A8Golang%25E3%2580%2582 )
* **七牛云**
* **bilibili**
* **今日头条**
* **美团**
...
* **src目录** ： 用于以代码包的显示组织并保存go源码文件。
* **pkg目录** : 用于存放通过go install 安装后的代码包的归档文件。
* **bin目录** : 与pkg相似，在通过go install 命令安装后生成的可执行文件。

#### 包导入 ####

` import ( . "github.com/Han-Ya-Jun/***" _ "github.com/Han-Ya-Jun/***" ) 复制代码`
...
` BitBucket (Mercurial Git) GitHub (Git) Google Code Project Hosting (Git, Mercurial, Subversion) Launchpad (Bazaar) 复制代码`

所以为了go get 能正常工作，你必须确保安装了合适的源码管理工具，并同时把这些命令加入你的PATH中。其实go get支持自定义域名的功能，具体参见go help remote。 go get 命令本质上可以理解为：首先通过源码工具clone代码到src目录，然后执行go install。

##### go install #####

go install 命令在内部实际上分成了两步操作：第一步是生成结果文件(可执行文件或者.a包)，第二步会把编译好的结果移到 ![GOPATH/pkg 或者](https://juejin.im/equation?tex=GOPATH%2Fpkg%20%E6%88%96%E8%80%85) GOPATH/bin。
...
` ok archive/tar 0.011s FAIL archive/zip 0.022s ok compress/gzip 0.033s ... 复制代码`
...
[github.com/hyper0x/go_…]( https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Fhyper0x%2Fgo_command_tutorial )